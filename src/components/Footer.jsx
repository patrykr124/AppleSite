...
function Footer() {
    ...
    useEffect(() => {
        Promise.all([
            fetch('http://localhost:5000/products/iphone').then(res => res.json()).then(data => setProductsIphone(data)),
            fetch('http://localhost:5000/products/macbook').then(res => res.json()).then(data => setProductsMacbook(data))
